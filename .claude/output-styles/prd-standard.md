...
|---------|----------|-------------|-------------------|
| [Feature 1] | High | [Description] | [Criteria] |
| [Feature 2] | Medium | [Description] | [Criteria] |

### 4.2 Functional Requirements
- **FR1**: [Detailed functional requirement]
- **FR2**: [Detailed functional requirement]
...
### 5.1 User Journey
[Step-by-step user flow and key touchpoints]
...
- Extract key information from the input and map it to appropriate PRD sections
- Fill in missing sections with placeholders or reasonable assumptions
