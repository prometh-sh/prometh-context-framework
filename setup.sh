...
echo "    From PRD: /prometh-spec --from-prd docs/prds/mobile-platform-prd.md"
echo "    Output: docs/specs/[type]-[name]-spec.md"
echo
echo "  Guided Implementation (BUILD):"
echo "    Execute SPEC: /prometh-build docs/specs/user-auth-spec.md"
echo "    Resume session: /prometh-build docs/specs/payment-spec.md"
echo "    Output: Interactive workflow with PROMETH.md tracking"
echo
