...
echo "  /prometh-prd-normalize [filename] - Convert documents to PRDs"
echo "  /prometh-document readme          - Generate comprehensive README.md files"
echo "  /prometh-document [type]          - Generate technical documentation"
echo "  /prometh-init [--think]           - Smart repository analysis and PRD generation"
echo
echo -e "${BLUE}Available output styles:${NC}"
echo "  prometh-prd-standard           - General requirements and features"
echo "  prometh-prd-bugfix             - Bug/issue reports → PRD conversion"
echo "  prometh-prd-feature            - New feature requests with market analysis"
echo "  prometh-prd-codebase-analysis  - Repository analysis and initialization PRDs"
...
echo "    2. Run: /prometh-prd-normalize"
echo "    3. Find standardized PRDs in docs/prds/"
echo
echo "  README Generation:"
echo "    1. Navigate to your repository"
echo "    2. Run: /prometh-document readme"
echo "    3. Find generated README.md (or README-new.md if one exists)"
echo
echo "  Repository Initialization:"
echo "    1. Navigate to repository with poor documentation"
echo "    2. Run: /prometh-init --think (or --think-hard, --think-harder, --ultrathink)"
echo "    3. Find comprehensive PRDs generated in docs/prds/"
echo
