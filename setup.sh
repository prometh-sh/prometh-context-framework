...
echo "  /prometh-build <spec-file-path>      - Execute SPEC with guided implementation tracking"
...
echo "  /prometh-prd → /prometh-spec → /prometh-build → Delivery"
echo "  Strategic      Implementation    Guided          Complete"
echo "  Vision         Planning          Execution       Traceability"
echo
echo -e "${BLUE}Key Features:${NC}"
echo "  ✅ End-to-End Lifecycle - From strategic planning to guided delivery"
echo "  ✅ Interactive Implementation - /prometh-build provides guided SPEC execution"
echo "  ✅ Progress Tracking - Real-time updates in PROMETH.md with phase transitions"
...
echo "    Output: prometh-docs/prds/[name]-prd.md (or prometh-docs.local/prds/)"
echo
echo "  Implementation Planning (SPECs):"
echo "    Interactive: /prometh-spec"
echo "    From file: /prometh-spec user-story.md"
echo "    From PRD: /prometh-spec --from-prd prometh-docs/prds/mobile-platform-prd.md"
echo "    Output: prometh-docs/specs/[type]-[name]-spec.md (or prometh-docs.local/specs/)"
echo
echo "  Guided Implementation (BUILD):"
echo "    Execute SPEC: /prometh-build prometh-docs/specs/user-auth-spec.md"
echo "    Resume session: /prometh-build prometh-docs/specs/payment-spec.md"
echo "    Output: Interactive workflow with tracking file (PROMETH.md or PROMETH.local.md)"
echo
...
echo "3. Create strategic PRDs with '/prometh-prd'"
echo "4. Generate implementation SPECs with '/prometh-spec'"
echo "5. Execute SPECs with guided tracking via '/prometh-build'"
echo "6. Monitor progress with '/prometh-status'"
echo "7. Get help anytime with '/prometh-help'"
echo
